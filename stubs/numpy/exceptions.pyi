...
import typing
__all__: list = ['ComplexWarning', 'VisibleDeprecationWarning', 'ModuleDeprecationWarning', 'TooHardError', 'AxisError', 'DTypePromotionError']
class AxisError(ValueError, IndexError):
    ...
    """
    __slots__: typing.ClassVar[tuple] = ('axis', 'ndim', '_msg')
