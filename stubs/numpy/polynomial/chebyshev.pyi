...
class Chebyshev(numpy.polynomial._polybase.ABCPolyBase):
    ...
    basis_name: typing.ClassVar[str] = 'T'
    ...
    def _val(x, c, tensor = True):
        ...
        """
    @classmethod
    def interpolate(cls, func, deg, domain = None, args = tuple()):
        """
...
def chebgrid3d(x, y, z, c):
    ...
    """
def chebint(c, m = 1, k = list(), lbnd = 0, scl = 1, axis = 0):
    """
    ...
    """
def chebinterpolate(func, deg, args = tuple()):
    """
    Interpolate a function at the Chebyshev points of the first kind.
...
def poly2cheb(pol):
    ...
    """
chebdomain: numpy.ndarray  # value = array([-1,  1])
chebone: numpy.ndarray  # value = array([1])
chebx: numpy.ndarray  # value = array([0, 1])
chebzero: numpy.ndarray  # value = array([0])
