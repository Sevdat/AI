...
class Hermite(numpy.polynomial._polybase.ABCPolyBase):
    ...
    basis_name: typing.ClassVar[str] = 'H'
...
def hermgrid3d(x, y, z, c):
    ...
    """
def hermint(c, m = 1, k = list(), lbnd = 0, scl = 1, axis = 0):
    """
...
def poly2herm(pol):
    ...
    """
hermdomain: numpy.ndarray  # value = array([-1,  1])
hermone: numpy.ndarray  # value = array([1])
hermx: numpy.ndarray  # value = array([0. , 0.5])
hermzero: numpy.ndarray  # value = array([0])
