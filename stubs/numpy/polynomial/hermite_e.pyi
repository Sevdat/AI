...
from numpy.polynomial.polyutils import trimcoef as hermetrim
import typing
__all__: list = ['hermezero', 'hermeone', 'hermex', 'hermedomain', 'hermeline', 'hermeadd', 'hermesub', 'hermemulx', 'hermemul', 'hermediv', 'hermepow', 'hermeval', 'hermeder', 'hermeint', 'herme2poly', 'poly2herme', 'hermefromroots', 'hermevander', 'hermefit', 'hermetrim', 'hermeroots', 'HermiteE', 'hermeval2d', 'hermeval3d', 'hermegrid2d', 'hermegrid3d', 'hermevander2d', 'hermevander3d', 'hermecompanion', 'hermegauss', 'hermeweight']
class HermiteE(numpy.polynomial._polybase.ABCPolyBase):
    """
    ...
    basis_name: typing.ClassVar[str] = 'He'
...
def hermegrid3d(x, y, z, c):
    ...
    """
def hermeint(c, m = 1, k = list(), lbnd = 0, scl = 1, axis = 0):
    """
...
def poly2herme(pol):
    ...
    """
hermedomain: numpy.ndarray  # value = array([-1,  1])
hermeone: numpy.ndarray  # value = array([1])
hermex: numpy.ndarray  # value = array([0, 1])
hermezero: numpy.ndarray  # value = array([0])
